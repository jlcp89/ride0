...
| T-005 | Filter by status | GET /api/rides/?status=pickup | 200, all returned rides have status="pickup" | P0 |
...
| T-007 | Combined filters | GET /api/rides/?status=pickup&rider_email=alice@wingz.com | 200, all rides match both status AND rider email | P1 |
...
| T-012 | Filter + sort compose | GET /api/rides/?status=pickup&sort_by=pickup_time | 200, only pickup rides, ordered by pickup_time | P1 |
