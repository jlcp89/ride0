...
| T-005 | Filter + distance sort compose | GET /api/rides/?status=to-pickup&sort_by=distance&latitude=14.5995&longitude=-90.5131 | 200, only to-pickup rides returned, sorted by distance nearest first | P1 |
